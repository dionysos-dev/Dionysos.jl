...
include(joinpath(dirname(dirname(pathof(Dionysos))), "problems/simple_pendulum", "safety_unstable_equilibrium.jl"))  # safety_stable_equilibrium.jl safety_unstable_equilibrium.jl
...
nstep = 100
x0 = SVector(pi+0.15,0.5) # SVector(0.15,0.0) #
control_trajectory =
