...
# Data
# ------------------------------------------------
nprocs_vals = [3, 10, 20, 40, 60]

worker_creation          = [10.0, 8.5, 8.9, 11.0, 8.9]
worker_package_load      = [6.0, 6.0, 8.3, 12.0, 8.8]
warmup                   = [25.0, 31.0, 37.0, 58.0, 65.9]
abstraction_construction = [2900.0, 949.0, 510.0, 276.0, 180.0]
total                    = [2930.0, 984.0, 551.0, 338.0, 250.0]
...
plot!(p1, nprocs_vals, abstraction_construction; label="abstraction construction", marker=:utriangle)
...
plot!(p2, nprocs_vals, abstraction_construction; label="abstraction construction", marker=:utriangle)
