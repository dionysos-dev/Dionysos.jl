#!/bin/bash
#SBATCH --job-name=dionysos_distributed
...
# ── Configuration ──────────────────────────────────────────────
# Usage: sbatch slurm/run_distributed.sh <example.jl>
EXAMPLE_SCRIPT="${1:?Usage: sbatch run_distributed.sh <example.jl>}"
NPARTS=${SLURM_NTASKS:-8}
...
echo "=========================================="
echo "  SLURM Distributed – Dionysos"
