...
function problem(; approx_mode = "growth")
    ...
    _S_ = UT.HyperRectangle(SVector(pi-30.0*pi/180.0, -1.0), SVector(pi+30.0*pi/180.0, 1.0))
    _S_ = UT.HyperRectangle(SVector(pi-20.0*pi/180.0, -1.0), SVector(pi+20.0*pi/180.0, 1.0))
