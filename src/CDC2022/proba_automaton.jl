...
NewProbaAutomaton(nstates, nsymbols) = ProbaAutomaton{UT.SortedTupleSet{4,Tuple{Int,Int,Int,Float64}}}(nstates, nsymbols)
...
function delete_transition_post!(autom::ProbaAutomaton, source, symbol)
    UT.delete!(autom.transitions, (source, symbol), comparison)
end
