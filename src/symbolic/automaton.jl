...
function compute_post!(targetlist, autom::AutomatonList, source, symbol, time)
    return UT.fix_and_eliminate_tail!(targetlist, autom.transitions, (source, symbol, time))
end
