...
| E4 | [`gol_lazar_belta_example.jl`](gol_lazar_belta_example.jl) | The construction contains the predecessor as `\|S\| = 1` | validation against published numbers | rate **0.9400** vs their 0.94; **11** slices vs their 11; 6 332 cells |
