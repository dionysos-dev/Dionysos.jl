...
# LVServerTransport.run_json_server(endpoint="tcp://*:5556", verbose=true) 
# {"cmd":"load_controller","args":{"path":"C:/path/to/controller.file"}}, {"cmd":"step_controller","args":{"x":[0.1,0.2,0.3,0.4],"t":0.01}}
