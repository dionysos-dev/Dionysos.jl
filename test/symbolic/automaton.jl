...
run_automaton_tests((n, m) -> SY.SortedAutomatonList(n, m))
run_automaton_tests((n, m) -> SY.IndexedAutomatonList(n, m))
run_automaton_tests((n, m) -> SY.FastIndexedAutomatonList(n, m))
