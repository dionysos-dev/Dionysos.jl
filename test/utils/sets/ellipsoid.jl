...
@testset "EllipsoidOperations" begin
    ...
    @test !isdisjoint(E1, E)
    @test !isdisjoint(E, E1)
    ...
    @test err <= 10e-4
    @test issubset(E1, E) == false
    @test issubset(E, E1) == true
    @test issubset(E, E1scaled) == false
    @test issubset(E1scaled, E) == false
    ...
    @test err <= 10e-2
    @test issubset(E, UT.Ellipsoid(E1scaled2.P * 0.99, E1scaled2.c)) == true
    ############################################
    a = 1.2
    E1 = UT.Ellipsoid(P0, c0 + [a; a])
